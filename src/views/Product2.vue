          ...
          >
            ...
            <div class="px-2 space-y-1">
              ...
              <div class="flex items-center justify-between pt-3">
                ...
                <button @click.stop.prevent="alert('เพิ่มลงตะกร้าแล้ว')" class="bg-[#F0F4F0] hover:bg-[#13ec25] text-[#13ec25] hover:text-white size-10 rounded-xl flex items-center justify-center transition-all shadow-sm">
